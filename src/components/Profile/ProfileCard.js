...
import { Avatar, Button, Divider, Skeleton, Space, Statistic, Tag, notification } from 'antd'
    ...
    useEffect(() => {
        if (user) {
            setStaticValue([
                {
                    title: "Age",
                    value: user.basicInformation.age,
                    suffix: "Years"
                },
                {
                    title: "Height",
                    value: user.basicInformation.height,
                    suffix: "Inch"
                },
                {
                    title: "Sub Caste",
                    value: user.basicInformation.subCaste,
                },
                {
                    title: "Marital Status",
                ...
                {
                    title: "Mother Tongue",
                    value: user.basicInformation.motherTongue,
                },
                {
                    title: "Living In",
                    value: user.basicInformation.livingIn,
                }
            ])
        }
    }, [user])
